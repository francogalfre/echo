...
export const ApiHero = ({ request, response }: ApiHeroProps): React.ReactElement => (
  <div
    className={[
      "rounded-lg p-6 ring-1 ring-foreground/10 sm:p-8",
  ...
  >
    <div className="mb-6 flex items-center gap-2">
      ...
      <p className="text-sm font-medium text-foreground">Send feedback, get confirmation</p>
    </div>
    ...
    <div className="grid items-center gap-6 lg:grid-cols-[1fr_auto_1fr]">
      ...
      <div>
        <p className="micro-label mb-2.5">Response</p>
